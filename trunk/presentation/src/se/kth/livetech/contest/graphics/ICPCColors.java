...
public class ICPCColors {
	...
	public static final Color GOLD = new Color(180,155,30);
	public static final Color SILVER = new Color(180,180,190);
	public static final Color BRONZE = new Color(140,70,50);
